            ...
            <div className="container py-4">
                <div className="row gy-4 gx-5 d-flex align-items-center mx-5">
                    <div className="col-lg-4 col-md-6">
                        ...
                        <p className="small text-muted mb-0">Copyright &copy; 2021 All Rights Reserved. <a className="text-primary text-white" href="#">Hamdan</a></p>
                    </div>
                    <div className="col-lg-4 col-md-6 ms-auto">
                        <h5 className="text-white mb-3">MediCare</h5>
                        <p className="small text-muted">MediCare Health Center</p>
                        <div
                            className="bg-dark col-lg-6 d-flex justify-content-evenly
                mx-auto p-2"
                        >
                            <span>
